                    ...
                    `
                        <article class='margin_article'>
                            <div class="project">
                                ...
                                <div class="project-pic" style = "background: url(${profileDataArray[count].data?.projectImage}); background-size: cover; background-position: center;">
    ...
    filteredPosts.forEach(post => {
        ...
        newDiv.innerHTML = `
            <article class='margin_article'>
                <div class="project">
                    <div class="project-profile">
                        <div class="project-pic" style = "background: url(${post.data?.projectImage}); background-size: cover; background-position: center;">
                        <div class="project-name">khushpreet kaur</div>
                    </div>
